...
- This cluster was further inspected in the 03_pass1_quality_reclustering.Rmd script.
```{r cluster0}
VlnPlot(mouse.unannotated,
...
pdf(paste0(out, "markers/cluster_markers_violin_annotated.pdf"), width = 8, height = 8)
v1
dev.off()
...
makeShinyApp(obj = shiny.obj, 
             scConf = sc.config, 
             gene.mapping = TRUE,
             shiny.title = "Pass 1, All Clusters")

# manual config edits
sc1conf <- readRDS("shinyApp/sc1conf.rds")
sc1conf[2,4] <- "red|blue|gold|orange|cyan|green|forestgreen|darkorchid1|red3|gray|deeppink|chocolate4|tan|steelblue|pink|black"
