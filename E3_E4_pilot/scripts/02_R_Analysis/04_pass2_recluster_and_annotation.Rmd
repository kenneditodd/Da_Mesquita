...
barcodes_to_remove <- c(readRDS("../../rObjects/pass1_group1_cells_to_remove.rds",
                                "../../rObjects/pass2_group2_cells_to_remove.rds"))
table(barcodes_to_remove %in% rownames(mouse.annotated@meta.data))
...
u1
saveToPDF(paste0(out, "UMAP/unannotated_clusters_dim1&2.pdf"), width = 6, height = 5)
dev.off()

u2
saveToPDF(paste0(out, "UMAP/unannotated_clusters_dim2&3.pdf"), width = 6, height = 5)
dev.off()
```
...
v3 <- VlnPlot(mouse.unannotated,
              ...
              flip = TRUE,
              cols = cluster_colors,
              features = c("C1qb","P2ry12","Itgax","Itgae","Ccr2","Flt1","Flt4","Col1a1","Acta2","Cd3e","Cd19","Pax5",
                           "Sdc1","Prdm1","Rag1","Rag2","Itgam","Gata3","Mki67"))
v3
```
...
pdf(paste0(out, "markers/kennedi_markers_violin_unannotated.pdf"), width = 8, height = 6)
v3
dev.off()
```
...
mouse.annotated <- RenameIdents(object = mouse.unannotated,
                                "0" = "Macrophages 1",       # Aoah,Adap2
                                "1" = "Endothelial",         # Flt1
                                "2" = "Macrophages 2/DCs?",  # C1qb,Ccr2
                                "3" = "Endothelial",         # Flt1
                                "4" = "Fibroblasts",         # Col1a1
                                "5" = "T and NK cells",      # Cd247,Ms4a4b
                                "6" = "Macrophages 3?",      # 
                                "7" = "Neutrophils",         # Hp
                                "8" = "B cells",             # Pax5,Ms4a41
                                "9" = "Endothelial",         # Vwf
                                "10" = "Pericytes and SMCs", # Notch3
                                "11" = "ILCs",               # Gata3
                                "12" = "Fibroblasts",        # Col1a1,Col1a2
                                "13" = "ILCs",               # Gata3
                                "14" = "Mast cells",         # Kit
                                "15" = "Schwann cells",      # Mpz
                                "16" = "Myeloid precursors", # Mki67
                                "17" = "Plasma cells",       # Sdc1
                                "18" = "Immature B cells")   # Cd19,Rag1,Rag2
...
mouse.annotated$annotated_clusters <- factor(mouse.annotated$annotated_clusters,
                                             levels = c("Pericytes and SMCs",
                                                        ...
                                                        "Schwann cells"))
Idents(mouse.annotated) <- "annotated_clusters"
saveRDS(mouse.annotated, "../../rObjects/pass2_annotated.rds")
```

# Annotated QC
## UMAP
```{r annotated_pass2_umap}
cluster_colors <- c("red","orange","cyan","blue","steelblue","darkgreen",
                    "gold","chartreuse4","pink","lightgreen","purple","gray","chocolate4",
                    "tan","black")
...
```{r save_pass2_unannotated_umap, echo=FALSE, eval=FALSE}
u1
saveToPDF(paste0(out, "UMAP/annotated_clusters_dim1&2.pdf"), width = 6, height = 4)
dev.off()

u2
saveToPDF(paste0(out, "UMAP/annotated_clusters_dim2&3.pdf"), width = 6, height = 4)
dev.off()
```
...
v3 <- VlnPlot(mouse.annotated,
              ...
              flip = TRUE,
              cols = cluster_colors,
              features = c("C1qa","C1qb","Flt1","Cldn5","Col1a1","Col1a2",
                           "Myh11","Rgs5","Nkain2"))
v3
```

```{r save_annotated_cluster_markers, eval=FALSE, echo=FALSE}
pdf(paste0(out, "markers/auto_top3_markers_violin_annotated.pdf"), width = 12, height = 10)
v1
dev.off()
...
sc1conf[2,4] <- "red|orange|cyan|blue|steelblue|darkgreen|gold|chartreuse4|pink|lightgreen|purple|gray|chocolate4|tan|black"
