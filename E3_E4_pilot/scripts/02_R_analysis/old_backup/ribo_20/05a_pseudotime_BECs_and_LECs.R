...
# Plot UMAP
path <- "../../results/ribo_20/reclusterEndothelial/pseudotime/UMAP_individual_clusters.pdf"
...
# Plot trajectory
path <- "../../results/ribo_20/reclusterEndothelial/pseudotime/UMAP_individual_cluster_trajectory.pdf"
...
# Plot pseudotime
path <- "../../results/ribo_20/reclusterEndothelial/pseudotime/UMAP_individual_cluster_pseudotime.pdf"
pdf(path, height = 6, width = 8)
plot_cells(cds,
...
dev.off()
# split by sex
path <- "../../results/ribo_20/reclusterEndothelial/pseudotime/UMAP_individual_cluster_pseudotime_split_sex.pdf"
pdf(path, height = 6, width = 8)
plot_cells(cds,
           color_cells_by = "pseudotime",
           label_groups_by_cluster = FALSE,
...
dev.off()
# split by age
path <- "../../results/ribo_20/reclusterEndothelial/pseudotime/UMAP_individual_cluster_pseudotime_split_age.pdf"
pdf(path, height = 6, width = 8)
plot_cells(cds,
           color_cells_by = "pseudotime",
           label_groups_by_cluster = FALSE,
...
dev.off()
# split by isoform
path <- "../../results/ribo_20/reclusterEndothelial/pseudotime/UMAP_individual_cluster_pseudotime_split_isoform.pdf"
pdf(path, height = 6, width = 8)
plot_cells(cds,
           color_cells_by = "pseudotime",
           label_groups_by_cluster = FALSE,
