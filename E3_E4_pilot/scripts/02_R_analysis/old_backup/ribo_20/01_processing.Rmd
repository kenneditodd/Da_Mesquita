...
```{r save_filtered_object, echo=FALSE, eval=TRUE}
saveRDS(mouse.filtered, "../../rObjects/mouse_filtered.rds")
mouse.filtered <- readRDS("../../rObjects/mouse_filtered.rds")
```
...
# save
grid <- grid.arrange(grobs = plots, layout_matrix = layout)
path <- "../../results/ncells/cells_per_sample_before_and_after_filtering"
saveToPDF(paste0(path, ".pdf"), width = 8, height = 4)
dev.off()
...
# save
pca1
path <- paste0("../../results/cellcycle/mouse_cell_cycle_phase_PCA_split")
saveToPDF(paste0(path, ".pdf"), width = 6, height = 6)
dev.off()
...
# save
percent.phase
path <- "../../results/cellcycle/mouse_cell_cycle_percent_phase_per_sample"
...
# save
pca1
path <- paste0("../../results/mitochondria/mouse_mitochondria_quartile_PCA_split")
saveToPDF(paste0(path, ".pdf"), width = 8, height = 6)
dev.off()
...
# save
percent
path <- "../../results/mitochondria/mouse_mitochondria_quartile_percent_per_sample"
saveToPDF(paste0(path, ".pdf"), width = 8, height = 6)
dev.off()
...
saveRDS(mouse.unannotated, paste0("../../rObjects/mouse_unannotated.rds"))
```
