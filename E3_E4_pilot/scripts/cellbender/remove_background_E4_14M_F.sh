...
cellbender remove-background \
			--input /research/labs/neurology/fryer/m214960/Ferreira_Da_Mesquita/count/E4_14M_F/outs/raw_feature_bc_matrix.h5 \
			--output pass2_E4_14M_F_fpr_0.05.h5 \
