...
```{r,echo=FALSE,eval=FALSE}
ncells
path <- "../../results/all_clusters_pass1/clustering_QC/cells_per_cluster"
saveToPDF(paste0(path, ".pdf"), width = 8, height = 6)
dev.off()
```
...
# write table
write.table(e4.male.df, "../../results/all_clusters_pass1/DEGs/DEG_tables/E4PM_vs_E4CM_DEGs.tsv", 
            sep = "\t", quote = FALSE, row.names = FALSE)
```
...
# write table
write.table(e3.female.df, "../../results/all_clusters_pass1/DEGs/DEG_tables/E3PF_vs_E3CF_DEGs.tsv", 
            sep = "\t", quote = FALSE, row.names = FALSE)
```
...
# write table
write.table(e4.female.df, "../../results/all_clusters_pass1/DEGs/DEG_tables/E4PF_vs_E4CF_DEGs.tsv", 
            sep = "\t", quote = FALSE, row.names = FALSE)
```
...
write.table(male.control.df, 
            "../../results/all_clusters_pass1/DEGs/DEG_tables/E4CM_vs_E3CM_DEGs.tsv", 
            sep = "\t", quote = FALSE, row.names = FALSE)
```
...
write.table(female.control.df, 
            "../../results/all_clusters_pass1/DEGs/DEG_tables/E4CF_vs_E3CF_DEGs.tsv", 
            sep = "\t", quote = FALSE, row.names = FALSE)
```
...
for (i in clusters) {
  ...
  i <- gsub("/","_",i)
  i <- gsub("-","_",i)
  prefix <- "../../results/all_clusters_pass1/DEGs/upset/upreg_"
...
for (i in clusters) {
  ...
  i <- gsub("/","_",i)
  i <- gsub("-","_",i)
  prefix <- "../../results/all_clusters_pass1/DEGs/upset/downreg_"
  pdf(paste0(prefix, tolower(i), ".pdf"), height = 6, width = 10)
  print(upset_gene)
  dev.off()
}
...
prefix <- "../../results/all_clusters_pass1/DEGs/"
...
# get file list
files <- list.files("../../results/all_clusters_pass1/DEGs/DEG_tables/")
keep <- grep("_DEGs.tsv", files)
files <- files[keep]
files <- paste0("../../results/all_clusters_pass1/DEGs/DEG_tables/", files)
...
for (i in 1:length(files)) {
  ...
  for (j in cell_types) {
    ...
    clus <- gsub("/","_",clus)
    clus <- gsub("-","_",clus)
    file <- gsub("../../results/all_clusters_pass1/DEGs/DEG_tables/", "", files[i])
    file <- gsub("_DEGs.tsv", "", file)
    file <- paste0("../../results/all_clusters_pass1/DEGs/metascape_input/", file, "/", clus)
